...
export default async function PreviewPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  const allOtherReviews = await db.review.findMany({
    where: { published: true, slug: { not: review.slug as string } },
  ...
  const moreReviews = getRelated(
    { genres: review.genres as string[], tags: review.tags as string[], director: review.director as string, releaseYear: review.releaseYear as number, tmdbCollectionId: review.tmdbCollectionId as number | null },
    allOtherReviews
  )
